...
package dev.jab125.discordsocialsdk.impl.c;
...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cdiscord_h.C_POINTER.withName("__routine"),
        cdiscord_h.C_POINTER.withName("__arg"),
        cdiscord_h.C_POINTER.withName("__next")
    ...
    public final static class __routine {
        ...
        private static final MethodHandle UP$MH = cdiscord_h.upcallHandle(__routine.Function.class, "apply", $DESC);
